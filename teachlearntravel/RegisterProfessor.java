...
public class RegisterProfessor extends AppCompatActivity {
            ...
            public void onFocusChange(View v, boolean hasFocus) {
                if (!hasFocus) {
                    ...
                    if (password.getText().toString().matches(passStyle));
                        ...
                        Toast.makeText(RegisterProfessor.this, "Note - password is weak!", Toast.LENGTH_SHORT).show();
                    }
                }
        ...
        rf.putFile(uri)
                ...
                .addOnFailureListener(new OnFailureListener() {
                    ...
                    public void onFailure(@NonNull Exception exception) {
                        ...
                        pd.dismiss();
                        Toast.makeText(RegisterProfessor.this, "Failed" + exception.getMessage(), Toast.LENGTH_SHORT).show();
                        // ...
                    }
                    ...
                    if (phone.getText().toString().isEmpty()) {
                        ...
                        if (conn == null)
                            ...
                            if(genderf.isChecked())
                                gen="Female";
                            String ss = db.rundml("insert into [Professor] values(N'" + fullname.getText() + "','" + emailaddress.getText() +"','" + gen + "','" + phone.getText() + "','" + password.getText() + "','" + path + "','"+ MapsActivity.l + "','" + MapsActivity.g +"')");
                            if (ss.equals("Done")) {
                                AlertDialog.Builder m = new AlertDialog.Builder(RegisterProfessor.this)
                                        .setTitle("Register...")
                                        ...
                                        .setNegativeButton("Goto Login", new DialogInterface.OnClickListener() {
                                            ...
                                            public void onClick(DialogInterface dialog, int which) {
                                                startActivity(new Intent(RegisterProfessor.this, Finallogin.class));
                                            }
                                        });
                                m.create().show();
   ...
   //  if (requestCode==CAMERA_REQUEST&&resultCode== Activity.RESULT_OK){
     //    Bitmap photo = (Bitmap) data.getExtras().get("data");
       //  acountimg.setImageBitmap(photo);
    // }

    }

    public void gotomap(View view) {
        startActivity(new Intent(RegisterProfessor.this,MapsActivity.class));
    }
}